    ...
    $(form).validate({
        ...
        messages: {
            name: {
                ...
                minlength: $.validator.format("Введіть принаймні {0} символи")
            },
            email: {
            ...
            text: {
                ...
                minlength: $.validator.format("Введіть принаймні {0} символів")
            }
        }
    });
}
validateFormUk('form.uk');
    ...
    $(form).validate({
        ...
        messages: {
            name: {
                ...
                minlength: $.validator.format("Please type at least {0} characters")
            },
            email: {
                required: "Please enter your email",
                email: "Incorrect e-mail number entered"
            },
            text: {
                required: "Please outline the essence of your application",
                minlength: $.validator.format("Please type at least {0} characters")
            }
        }
    });
}
validateFormEn('form.en');

// PHP Mailer
$('form.uk').submit(function(e) {
    e.preventDefault();
    ...
    $.ajax({
        type: "POST",
        url: "wp-content/themes/equipyourmen/mailer/smart.php",
        data: $(this).serialize()
    }).done(function() {
        $(this).find("input").val("");
